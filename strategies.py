...
class Strategy():
    def __init__(self, client: typing.Union['BinanceFuturesClient', 'BitmexFuturesClient'], contract: Contract, exchange:str, timeframe:str, balance_pct: float, take_profit:float, stop_loss:float, strat_name):
        self.client = client
